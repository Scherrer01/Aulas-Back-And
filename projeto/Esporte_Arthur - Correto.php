...
class UFC extends Esporte{
    ...
    public function exibirInfo(){
    return "O " . $this->getModalidade() . " é um esporte de " . $this->getJogadores() . " lutador(es) na associação " . $this->getAssociacao() . " possuindo " . $this->getPonto() . " pontos de ranking, com " . $this->getTitulos() . " títulos e " . $this->getNocautes() . " nocautes.\n";
        }
